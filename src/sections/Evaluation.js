  ...
  return (
    <Section title={"Design Principles"}>
      <Paragraph title="Visibility of System Status">
        <TextContent>
          The app provides real-time feedback on the playing status, connection
          status, and errors. The playing status bar and notifications ensure
          that users are always aware of the app's current state. The app only
          sometimes provides clear and timely feedback about the status of
          ongoing processes. For example, whether the app attempts to connect to
          the server during the login process needs to be clarified. A visual
          indicator like a spinning wheel or progress bar would improve the user
          experience.
        </TextContent>
      </Paragraph>
      ...
      <Paragraph title="Error Prevention">
        <TextContent>
          ...
          password fields during the login process to ensure the entered data is
          correct before submitting the login request.
        </TextContent>
      </Paragraph>
      <Paragraph title="Recognition vs. Recall in User Interfaces">
        <TextContent>
          The app uses icons, labels, and tooltips to help users recognize
          functions and controls. Familiar icons and design elements allow users
          to transfer knowledge from other music apps, reducing the need for
          recall. The app's navigation and menu system could be improved by
          making it more intuitive and discoverable. Users may need to recognize
          that they can swipe right to access the menu from the Library page. A
          more visible and consistent menu icon throughout the app would help
          users easily identify and navigate to the desired section.
        </TextContent>
      </Paragraph>
      ...
      <Paragraph title="Aesthetic and Minimalist Design">
        <TextContent>
          ...
          better integrated with the overall app design. Additionally, the Album
          Detail page can be improved by providing a more consistent layout for
          song lists in the grid and list views.
        </TextContent>
      </Paragraph>{" "}
      <Paragraph title="Help Users Recognize, Diagnose, and Recover from Errors">
        <TextContent>
          ...
          issues. This helps users understand what went wrong and how to fix it,
          reducing frustration and promoting a positive user experience. The app
          does not consistently provide clear error messages to help users
          understand and resolve issues. In cases where login credentials are
          incorrect, the app should give specific information about which field
          is wrong (e.g., incorrect password) rather than a generic error
          message.
        </TextContent>
      </Paragraph>{" "}
      <Paragraph title="Help & Documentation">
        <TextContent>
          ...
          messages that may occur. The app needs a comprehensive help section or
          documentation to assist users in troubleshooting issues or learning
          how to use the app's features. A built-in help section with searchable
          FAQs, tips, and tutorials can improve user experience and reduce
          frustration.
        </TextContent>
      </Paragraph>
    </Section>
